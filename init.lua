...
-- Reload the config
vim.api.nvim_set_keymap('n', '<Leader>R', ':so %<CR>', { desc = 'Reload Neovim config' })
...
require('lazy').setup({
  ...
  require 'plugins.auto-session', -- Auto-session
  require 'plugins.lazygit', -- Lazygit
  require 'plugins.tmux-navigator', -- Transition between Nvim and Tmux panes
  require 'plugins.render-markdown', -- Markdown renderer
  require 'plugins.debug', -- Debug Adapter Protocol
  require 'plugins.zen-mode', -- Zoom on buffer for free distraction editing
  require 'plugins.neotest', -- Plugin for launching tests
  ...
  require 'plugins.autopairs', -- Automatically closes parenthesis, quotes, brackets, etc.
