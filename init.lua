...
require('lazy').setup({
  ...
  -- vim-tmux-navigator
  -- Allows a smooth transition between nvim and tmux pane navigation preserving Vim split motions
  {
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- NOTE: commented <C-b> and <C-f> to avoid conflicts, stick to <C-u> (up) and <C-d> (down)
